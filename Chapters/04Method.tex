...
\section{Overall Simulation and Analysis Workflow}

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{Figures/04Method/Simulator Flow v2.png}
...
\section{Simulation Configuration and Assumptions}


\section{Data Processing and Comparison Metrics}
